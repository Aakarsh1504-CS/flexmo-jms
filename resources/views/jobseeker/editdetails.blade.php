                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="/storeinfo" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="twelfth_marks">12th Marks</label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="twelfth_marks" class="form-control"
                                                            placeholder="12th Marks" name="twelth[marks]" value="{{ $detail->twelth['marks'] ?? '' }}">
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="twelfth_school">12th School Name</label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="twelfth_school" class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="decimal" id="yoe" class="form-control"
