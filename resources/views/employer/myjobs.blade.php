        ...
        <div class="content-body">
            ...
            <section class="users-list-wrapper">
                <div class="users-list-filter px-1">
                    <form action="/filtermysearch" method="post">
                        @csrf
                                    ...
                                    <table id="users-list-datatable"   class="table">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                            ...
                                            <td>{{$data->location}}</td>
                                            <td><a href="/edit/{{$data->id}}/jobpost/{{$data->title}}"><i class="ft-edit-1"></i></a>
                                                <button type="button" onclick="deljob({{$data}})" style="color:red;background:none;border:none" data-toggle="modal" data-target="#danger">
                                                    <i class="la la-trash"></i>
                                                </button>
                                                <a href="/view/{{$data->id}}/applicants"><i class="la la-eye warning"></i></a>
