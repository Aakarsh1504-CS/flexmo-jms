                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="horz-layout-basic">Update Job Info</h4>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="/updatejob" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="projectinput1" class="form-control"
                                                            placeholder="Job Title" value="{{$job->title}}" name="title">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <textarea id="projectinput2" class="form-control" style="resize:none"
                                                            placeholder="Job Description"  name="description">{{$job->description}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="projectinput3" class="form-control"
                                                            placeholder="Job Location" value="{{$job->location}}" name="location">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="projectinput1" class="form-control"
                                                            placeholder="Company" value="{{$job->company}}" name="company">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="number" id="projectinput5" class="form-control"
                                                            placeholder="Minimum Years Of Experience" value="{{$job->min_yoe}}" name="min_yoe">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control"
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="number" id="projectinput5" class="form-control"
                                                            placeholder="Maximum Years Of Experience" value="{{$job->max_yoe}}" name="max_yoe">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="number" class="form-control" value="{{$job->min_comp}}" placeholder="Minimum Compensation In Lakhs Per Year" name="min_comp" id="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput7">Maximum Compensation - In Lakhs Per Year</label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="number" value="{{$job->max_comp}}" placeholder="Maximum Compensation In Lakhs Per Year" class="form-control" name="max_comp" id="">
                                                    </div>
                                                </div>
